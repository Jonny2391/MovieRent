package it.cgmconsulting.addone.exception;
...
public class ExceptionManagement {
    ...
    */
    ...
    public ResponseEntity<String> handleProva(RuntimeException ex){
        return new ResponseEntity<>(ex.getMessage(),HttpStatus.INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler ({MethodArgumentNotValidException.class}) //Se falliscono i controlli di validità
